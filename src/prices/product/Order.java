...
public class Order implements Tradable {
    ...
    public Order(String user, String product, Price price, int volume, BookSide side) throws InvalidReference {
...
//        return user + " " + side + " order: " + product +
//                " at " + price +
...
//    //    @Override
//    public String toString(){
//        return user + " " + side + " order: " + product + " at " + price + ", Orig Vol: " + originalVolume + ", Rem Vol: " + remainingVolume + ", Fill Vol: " + filledVolume + ", CXL Vol: " + cancelledVolume + ", ID: " + id;
//    }

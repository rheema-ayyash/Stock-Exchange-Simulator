...
import prices.product.users.ProductManager;
import prices.product.users.User;
import prices.product.users.UserManager;
import prices.Price;
import prices.PriceFactory;
import prices.product.Quote;
import prices.*;
import prices.product.*;
import prices.product.users.*;
import prices.product.users.publications.*;
import static prices.product.BookSide.BUY;
import static prices.product.BookSide.SELL;
